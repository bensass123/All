...
function doit(user) {
	...
	console.log('Zombie rolls a ' + zRoll);
	choice = parseInt(user.choice);

	if ((choice === zRoll) && (arms > 0)) {
	    zHealth -= randoDamage;
	    arms -= 1;
	    console.log('You chop off one of the zombies arms.');
	} else if (choice === zRoll && legs > 0) {
	    zHealth -= randoDamage;
	    legs -= 1;
	    console.log('You chop off one of the zombies legs.');
	} else if (choice === zRoll) {
	...
	console.log('Damage: ' + randoDamage);
	console.log('User health: ' + uHealth);
	console.log('Zombie health: ' + zHealth);
	console.log('Zombie has ' + legs + ' leg(s) left and ' + arms + ' arm(s) left');
